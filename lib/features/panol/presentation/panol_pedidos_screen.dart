...
enum _EstadoPedidoPanol { enProceso, pendiente, completado }
...
class PanolPedidosScreen extends ConsumerStatefulWidget {
	...
	@override
	ConsumerState<PanolPedidosScreen> createState() =>
			_PanolPedidosScreenState();
}
	...
	Widget build(BuildContext context) {
		return Padding(
			...
			child: Row(
				crossAxisAlignment: CrossAxisAlignment.center,
				children: const [
					Expanded(flex: 1, child: Text("N° PEDIDO", style: TextStyle(fontWeight: FontWeight.w700))),
					Expanded(flex: 1, child: Text("FECHA", style: TextStyle(fontWeight: FontWeight.w700))),
					Expanded(flex: 3, child: Text("PRODUCTO", style: TextStyle(fontWeight: FontWeight.w700))),
					Expanded(flex: 2, child: Text("ESTADO", style: TextStyle(fontWeight: FontWeight.w700))),
...
class _PanolPedidosActions extends StatelessWidget {
	...
	Widget build(BuildContext context) {
		...
		final terceroIcon =
			tieneStock ? Icons.download_done_outlined : Icons.shopping_cart_outlined;
			...
			children: [
				Expanded(
					child: OutlinedButton.icon(
						...
						label: const Text("VER", style: TextStyle(fontWeight: FontWeight.w700, fontSize: 11)),
